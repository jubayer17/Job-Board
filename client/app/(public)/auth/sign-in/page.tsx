...
export default function SignInPage() {
    ...
    return (
        <div className="min-h-screen flex w-full pt-20">
            ...
            <div className="hidden lg:flex w-1/2 relative bg-gray-900 overflow-hidden flex-col justify-between p-12 text-white">
                {/* Background Pattern */}
                ...
                <div className="relative z-10">
                    <div className="flex items-center gap-3 mb-12">
                        <div className="p-2 bg-white/10 backdrop-blur-sm rounded-none">
                            <Image src="/logo.png" alt="Logo" width={32} height={32} className="w-8 h-8 invert brightness-0 filter" />
                        </div>
                        <span className="text-2xl font-black tracking-tight uppercase">JobBoard</span>
                    </div>

                    <div className="space-y-6 max-w-lg">
                        <h1 className="text-5xl font-black tracking-tighter uppercase leading-tight">
                            Find Your <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-purple-400">Dream Job</span>
                            <br />Today
                        </h1>
                        <p className="text-lg text-gray-400 font-medium leading-relaxed">
                            Connect with top-tier companies and discover opportunities that match your skills and aspirations. Join thousands of professionals growing their careers.
                        </p>
                    </div>
                </div>
                ...
                <div className="relative z-10 pt-12 border-t border-white/10">
                    <blockquote className="space-y-2">
                        <p className="text-lg font-medium italic text-gray-300">
                            "This platform completely transformed my job search. The UI is stunning and the process is seamless."
                        </p>
                        <footer className="text-sm font-bold uppercase tracking-wide text-indigo-400">
                ...
                <div className="w-full max-w-md space-y-8">
                    ...
                    <form onSubmit={onSubmit} className="space-y-6">
                        <div className="space-y-4">
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <Input
                                        ...
                                        className={`pl-10 h-12 rounded-none border-gray-200 focus:border-indigo-500 focus:ring-indigo-500 transition-all ${errors.email ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : ''}`}
                                    />
                                </div>
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="password" className="text-xs font-bold uppercase tracking-wide text-gray-500">Password</Label>
                                <div className="relative">
                                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    ...
                                    <Input
                                        ...
                                        onChange={handleChange}
                                        className={`pl-10 h-12 rounded-none border-gray-200 focus:border-indigo-500 focus:ring-indigo-500 transition-all ${errors.password ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : ''}`}
                                    />
                                </div>
                        ...
                        <div className="flex items-center justify-between text-sm">
                            <div className="flex items-center space-x-2">
                                <input type="checkbox" className="rounded-none border-gray-300 text-indigo-600 focus:ring-indigo-500 transition-all" />
                                <span className="text-gray-500 font-medium">Remember me</span>
                            </div>
                            <Link href="/auth/forgot-password" className="text-indigo-600 font-bold hover:underline">
                                Forgot password?
                            </Link>
                        </div>
                    ...
                    <div className="text-center text-sm font-medium text-gray-500">
                        ...
                        <Link href="/auth/sign-up" className="font-bold text-indigo-600 hover:text-indigo-500 hover:underline underline-offset-4 transition-all">
                            Create an account
                        </Link>
                    </div>
                </div>
