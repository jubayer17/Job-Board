...
interface HiringManagerCardProps {
    postedBy: JobWithPoster['postedBy'];
}

export const HiringManagerCard = ({ postedBy }: HiringManagerCardProps) => {
    return (
        <div className="bg-gray-900 text-white p-6 shadow-sm">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    <p className="font-bold text-white">{postedBy?.name || "Confidential"}</p>
